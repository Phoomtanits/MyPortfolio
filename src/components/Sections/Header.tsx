    ...
    return (
      <>
        <button
          ...
          className="fixed right-2 top-2 z-40 rounded-md bg-green-500 p-2 ring-offset-gray-800/60 hover:bg-green-400 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 sm:hidden"
          onClick={toggleOpen}>
